...
const EnterOtp = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FFFFFF] flex flex-col max-w-md mx-auto md:max-w-lg xl:max-w-xl">
            <div className="w-full px-4 md:px-6 xl:px-8 flex justify-between items-center mt-8">
            ...
            <div className="mt-12 md:mt-16 flex items-center flex-col px-4 md:px-6 xl:px-8 flex-1">
                ...
                <button onClick={() => router.push('/dashboard')} className='bg-[#5732BF] mt-auto mb-8 w-full h-11.5 md:h-12 xl:h-14 cursor-pointer rounded-sm p-3 md:p-4 text-[#FFFFFF] text-sm md:text-base font-medium'>
                    Done
                </button>
            </div>
        </div>
