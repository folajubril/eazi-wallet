...
const Password = () => {
    return (
        <div className="flex flex-col min-h-screen bg-white w-full md:flex md:items-center md:justify-center">
            <div className="w-full max-w-md mx-auto md:max-w-lg xl:max-w-xl md:shadow-lg md:rounded-lg md:overflow-hidden">
                <div className='bg-[#F7F4FF] w-full h-[40vh] md:h-[35vh] xl:h-[30vh] flex flex-col gap-8 md:gap-12 items-center justify-center md:py-4'>
                    <div className="w-full px-4 md:px-6 xl:px-8 flex justify-between items-center md:hidden">
    ...
    return (
        <>
            {stage === 1 ? <div className="flex flex-col min-h-screen bg-white w-full md:flex md:items-center md:justify-center">
                <div className="w-full max-w-md mx-auto md:max-w-lg xl:max-w-xl md:shadow-lg md:rounded-lg md:overflow-hidden md:my-16">
                    <div className='md:py-4 bg-[#F7F4FF] w-full h-[40vh] md:h-[35vh] xl:h-[30vh] flex flex-col gap-8 md:gap-12 items-center justify-center'>
                        <TapPayIcon />
                        <PhoneIcon />
                    </div>
                    <div className='flex p-4 md:p-6 xl:p-8 flex-col flex-1'>
                        ...
                        <div className='mb-8 md:mb-12'>
                            ...
                            <div className="relative">
                                <select className="absolute max-w-20 md:max-w-24 xl:max-w-28 left-1 top-1 bottom-1 px-0.5 border-[#E1E3ED] bg-white focus:outline-none z-10 rounded-l-sm text-xs md:text-sm">
